...
<br /> ***Για το 3ο ζητούμενο*** Αρχικά άλλαξα τα **Latitude** και **Longitude** με αυτά του Syros Place Of Interest τα οποία βρήκα στο [latlong.net](https://www.latlong.net/)
